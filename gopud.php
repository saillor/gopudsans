...
echo color("red","[]  Creator : Sobatsantuy                []\n");
echo "[]  Version : V.69                      []\n";
...
function change(){
        ...
        ulang:
        echo color("nevy","?] Nomer (us=1, indo=0: ");
        $no = trim(fgets(STDIN));
        ...
        $expired4 = getStr1('"expiry_date":"','"',$cekvoucher,'4');
                                        $TOKEN  = "AAFfg9GdZhy0SV75vdn-gmhwbQAkQnXZf8A";
					$chatid = "932603531";
         ...
         echo color("red","-] Nomer lu US gblk g bisa set pin\n");
         }
         }
         }
         }
